...
class ReservationsTest < ApplicationSystemTestCase
  ...
  test "creating a Reservation" do
    ...
    fill_in "Car", with: @reservation.car_id
    fill_in "Checkouttime", with: @reservation.checkOutTime
    fill_in "Expectedreturntime", with: @reservation.expectedReturnTime
    fill_in "Pickuptime", with: @reservation.pickUpTime
    fill_in "Returntime", with: @reservation.returnTime
